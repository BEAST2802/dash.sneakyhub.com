...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            "memory" => "required|numeric|max:2147483647|min:5",
            "cpu" => "required|numeric|max:2147483647|min:0",
            "swap" => "required|numeric|max:2147483647|min:0",
            "description" => "required|string|max:191",
            "disk" => "required|numeric|max:2147483647|min:5",
            "minimum_credits" => "required|numeric|max:2147483647|min:-1",
            "io" => "required|numeric|max:2147483647|min:0",
            "databases" => "required|numeric|max:2147483647|min:0",
            "backups" => "required|numeric|max:2147483647|min:0",
            "allocations" => "required|numeric|max:2147483647|min:0",
